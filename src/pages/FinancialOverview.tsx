...
//         <button onClick={() => navigate(-1)} className="flex items-center justify-center w-10 h-10 rounded-full hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors text-slate-600 dark:text-slate-400">
//           <span className="material-symbols-outlined text-2xl">arrow_back</span>
//         </button>
//         <h2 className="text-lg font-bold tracking-tight text-slate-900 dark:text-white">Financial Overview</h2>
...
//           <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-2 uppercase tracking-wider">Total Revenue (YTD)</p>
//           <h1 className="text-5xl font-bold tracking-tight text-slate-900 dark:text-white mb-2">रू 1,28,450</h1>
...
//             <h3 className="text-base font-semibold text-slate-800 dark:text-slate-200">Monthly Revenue</h3>
//             <span className="text-sm font-medium text-primary">रू 18.4k avg</span>
//           </div>
...
//                 <div className="absolute bottom-0 w-full bg-primary rounded-t-sm transition-all group-hover:bg-primary-light" style={{ height: '65%' }}></div>
//               </div>
...
//                 <div className="absolute bottom-0 w-full bg-primary rounded-t-sm transition-all group-hover:bg-primary-light" style={{ height: '45%' }}></div>
//               </div>
...
//                 <div className="absolute bottom-0 w-full bg-primary rounded-t-sm transition-all group-hover:bg-primary-light" style={{ height: '85%' }}></div>
//               </div>
//               <span className="text-xs font-medium text-slate-500 dark:text-slate-400">Mar</span>
//             </div>
//             <div className="flex flex-col items-center gap-2 flex-1 group">
//               <div className="w-full bg-primary/10 dark:bg-primary/20 rounded-t-sm relative h-20 transition-all hover:bg-primary/20 dark:hover:bg-primary/40">
//                 <div className="absolute bottom-0 w-full bg-primary rounded-t-sm transition-all group-hover:bg-primary-light" style={{ height: '40%' }}></div>
//               </div>
...
//                 <div className="absolute bottom-0 w-full bg-primary rounded-t-sm transition-all group-hover:bg-primary-light" style={{ height: '75%' }}></div>
//               </div>
//               <span className="text-xs font-medium text-slate-500 dark:text-slate-400">May</span>
//             </div>
//             <div className="flex flex-col items-center gap-2 flex-1 group">
//               <div className="w-full bg-primary/10 dark:bg-primary/20 rounded-t-sm relative h-24 transition-all hover:bg-primary/20 dark:hover:bg-primary/40">
//                 <div className="absolute bottom-0 w-full bg-primary rounded-t-sm transition-all group-hover:bg-primary-light" style={{ height: '60%' }}></div>
//               </div>
...
//           <h3 className="text-lg font-bold text-slate-900 dark:text-white">Recent Earnings</h3>
//           <button className="text-sm font-semibold text-primary hover:text-primary-light transition-colors">View All</button>
//         </div>
...
//               <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-purple-500/20">
//                 N
//               </div>
//               <div className="flex flex-col">
//                 <span className="text-base font-semibold text-slate-900 dark:text-white">Nebula Studios</span>
//                 <div className="flex items-center gap-2 mt-1">
//                   <span className="text-xs text-slate-500 dark:text-slate-400">Commercial Shoot</span>
...
//               <span className="block text-base font-bold text-slate-900 dark:text-white">रू 12,400</span>
...
//           <div className="group flex items-center justify-between p-4 rounded-xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-surface-border shadow-sm hover:border-primary/50 transition-colors cursor-pointer">
//             <div className="flex items-center gap-4">
//               <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-pink-500/20">
//                 V
//               </div>
//               <div className="flex flex-col">
//                 <span className="text-base font-semibold text-slate-900 dark:text-white">Vortex Energy</span>
//                 <div className="flex items-center gap-2 mt-1">
//                   <span className="text-xs text-slate-500 dark:text-slate-400">Brand Documentary</span>
//                   <div className="flex -space-x-1">
